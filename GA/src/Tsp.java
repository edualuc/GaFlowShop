...
class FF implements Function<Genotype<EnumGene<Integer>>, Double>
{
...
public class Tsp {
    ...
    public static void main(String[] args) {
        ...
        Function<Genotype<EnumGene<Integer>>, Double> ff = new FF(adjacencyMatrix(stops));
        
        Factory<Genotype<EnumGene<Integer>>> gt = Genotype.of( 
        		PermutationChromosome.ofInteger(stops)   );
        
        final GeneticAlgorithm<EnumGene<Integer>, Double> ga = new GeneticAlgorithm<>(gt, ff, Optimize.MINIMUM);
